function timeseries_statsCluster_Regression(subjects,cfgMain)
...
filenamePLVSurrogate  = strcat(global_path2root,'\Subjects\','Subject',sprintf('%.2d',subj_idx),'\Timeseries','\ControlEGG_othesubject\median_sPLV_s',sprintf('%.2d',subj_idx),'.nii')
